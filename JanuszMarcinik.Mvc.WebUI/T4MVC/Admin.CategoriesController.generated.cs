...
namespace JanuszMarcinik.Mvc.WebUI.Areas.Admin.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_CategoriesController : JanuszMarcinik.Mvc.WebUI.Areas.Admin.Controllers.CategoriesController
    {
        public T4MVC_CategoriesController() : base(Dummy.Instance) { }

        [NonAction]
        partial void ListOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, JanuszMarcinik.Mvc.WebUI.Areas.Admin.Models.Categories.CategoryDataSource datasource);

        [NonAction]
        public override System.Web.Mvc.ActionResult List(JanuszMarcinik.Mvc.WebUI.Areas.Admin.Models.Categories.CategoryDataSource datasource)
        {
        ...
        [NonAction]
        partial void DataSourceOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, JanuszMarcinik.Mvc.WebUI.Areas.Admin.Models.Categories.CategoryDataSource datasource);

        [NonAction]
        public override System.Web.Mvc.ActionResult DataSource(JanuszMarcinik.Mvc.WebUI.Areas.Admin.Models.Categories.CategoryDataSource datasource)
        {
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, JanuszMarcinik.Mvc.WebUI.Areas.Admin.Models.Categories.CategoryViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(JanuszMarcinik.Mvc.WebUI.Areas.Admin.Models.Categories.CategoryViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Create);
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, JanuszMarcinik.Mvc.WebUI.Areas.Admin.Models.Categories.CategoryViewModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(JanuszMarcinik.Mvc.WebUI.Areas.Admin.Models.Categories.CategoryViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
