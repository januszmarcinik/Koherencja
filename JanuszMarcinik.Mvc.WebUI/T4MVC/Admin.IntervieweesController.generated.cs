...
{
    public partial class IntervieweesController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public IntervieweesController Actions { get { return MVC.Admin.Interviewees; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Admin";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Interviewees";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Interviewees";
        [GeneratedCode("T4MVC", "2.0")]
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_IntervieweesController : JanuszMarcinik.Mvc.WebUI.Areas.Admin.Controllers.IntervieweesController
    {
        public T4MVC_IntervieweesController() : base(Dummy.Instance) { }

        [NonAction]
        partial void ListOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, JanuszMarcinik.Mvc.WebUI.Areas.Admin.Models.Interviewees.IntervieweeDataSource datasource);

        [NonAction]
        public override System.Web.Mvc.ActionResult List(JanuszMarcinik.Mvc.WebUI.Areas.Admin.Models.Interviewees.IntervieweeDataSource datasource)
        {
        ...
        [NonAction]
        partial void DataSourceOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, JanuszMarcinik.Mvc.WebUI.Areas.Admin.Models.Interviewees.IntervieweeDataSource datasource);

        [NonAction]
        public override System.Web.Mvc.ActionResult DataSource(JanuszMarcinik.Mvc.WebUI.Areas.Admin.Models.Interviewees.IntervieweeDataSource datasource)
        {
